    ...
    try {
      ...
      const designs = [
        ...
        async () => {
          ...
          const end = new Date().getTime();
          const pingSeconds = (end - start) / 1000;
          const captionText = `✙ɴᴏᴠᴀ✙\n\n*ʀᴇsᴘᴏɴsᴇ ʀᴀᴛᴇ:* ${pingSeconds} seconds\n\n*Fact:*\n${fact.result.fact}\n\n✙ɴᴏᴠᴀ✙`;

          return { image: imageBuffer.data, caption: captionText };
        },
        async () => {
          const imageBuffer = await axios.get(
            "https://i.imgur.com/3Fq3Ucq.jpeg",
            {
              responseType: "arraybuffer",
            }
          );
...
smd({
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By ✙ɴᴏᴠᴀ✙, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
      await _0x50364b.bot.updateProfileStatus(_0x347b23);
      return await _0x50364b.reply("*Auto_Bio Succesfully enabled*" + ("\n  *Bio set:* " + _0x347b23 + "  \n  \n  *whatsapp bio automatically update in every minutes!*\n  "));
    }
  } catch (_0x4c629c) {
  ...
  if (bio && bio.autobio && typeof bio.autobio === "string" && bio.autobio != "false") {
    if (!isStartAutoBio) {
      ...
      abioJob = cron.schedule("*/1.5 * * * *", async () => {
        try {
          var _0x4b4b3b = "`";
          let _0x34c0a6 = bio.autobio == "true" || bio.autobio == "on" ? "Auto Bio By ✙ɴᴏᴠᴀ✙, ⏰Time: @time 🚀@bot" : bio.autobio;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rent '✙ɴᴏᴠᴀ✙' yet bro!*");
    }
    let _0x14cff4 = [...new Set([..._0x35816f.filter(_0x2822d6 => _0x2822d6.user).map(_0x2b342c => _0x2b342c.user)])];
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared '✙ɴᴏᴠᴀ✙'!*");
    }
    let _0x1b2187 = "*[✙ɴᴏᴠᴀ✙ Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent '✙ɴᴏᴠᴀ✙' yet bro!*");
    }
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has shared '✙ɴᴏᴠᴀ✙'!*");
    }
  } catch (_0x5bad57) {
      ...
      _0x1a9455.ev.on("messages.upsert", async _0x179239 => {
        ...
        try {
          ...
          if (_0x54bf7f && Config.HANDLERS.toLowerCase().includes("null")) {
            ...
            _0x28d709 = _0x4d45ba && prefixRegex.test(_0x4d45ba[0]) || _0x5d3c1a !== "263784562833" && _0xa42486.isAstro && _0x4d45ba[0] == ",";
          ...
          if (_0x28d709) {
            ...
            if (_0x2a3ea9) {
              let _0x70a0b4 = ["263784562833@s.whatsapp.net"];
        ...
        if (_0x552a47 == "text" || _0x552a47 == "conservation" || !_0x552a47) {
          ...
          _0x1c1df7 = {
            orderMessage: {
              ...
              message: "❏ " + _0x5959c0,
              orderTitle: "live",
              sellerJid: "263784562833@s.whatsapp.net"
            }
          };
