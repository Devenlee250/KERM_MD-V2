...
`;
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am ✙ɴᴏᴠᴀ✙ whatsapp bot._*");
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "NOVA tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `ã *✙ɴᴏᴠᴀ✙ â¢ MEDIAFIRE DOWNLOADER* ã\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("✙ɴᴏᴠᴀ✙ â¢ SONG DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("✙ɴᴏᴠᴀ✙ â¢ YOUTUBE DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("✙ɴᴏᴠᴀ✙ â¢ APK DOWNLOAD LIST")) {
